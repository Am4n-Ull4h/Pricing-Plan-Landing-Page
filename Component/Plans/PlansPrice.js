...
const PlansPrice = ({ tabs }) => {
  ...
  return (
    <div className="container mx-auto px-0 py-4">
      <div
        className="flex items-center bg-white w-[30%] rounded-pill mx-auto py-2 px-3 rounded-full"
      ...
      <div className="mt-9 w-[80%] mx-auto flex justify-between relative">
        {tabContents[activeTab].map((card) =>
          card.id == 2 || card.id == 5 || card.id == 8 ? (
            <div
              className="middle-card relative p-0 w-[31%] "
              style={{ borderRadius: "15px" }}
            >
              <div
                key={card.id}
                className={`text-white border py-[25px] px-[20px]   ${
                  card.id === 2 || card.id === 5 || card.id === 8
                    ? "middle-border"
                    : ""
                }`}
              ...
              >
                ...
                <button className="popular absolute top-[-13px] left-[35%] px-4 ">
            ...
            <div
              key={card.id}
              className={`relative text-white w-[31%] border py-[25px] px-[20px]  ${
                card.id === 2 ? "aman" : ""
              }`}
              style={{ borderRadius: "15px" }}
            >
              {card.id == 3 || card.id == 6 || card.id == 9 ? (
                <button className="hottest absolute top-[-13px] left-[35%] px-4 font-bold">
