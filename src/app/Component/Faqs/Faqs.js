...
const Faqs = () => {
  ...
  return (
    <div className="max-w-[70%] mx-auto overflow-hidden mt-5">
      <div className="flex flex-col gap-[30px]">
        <div className="flex justify-center gap-10 items-center">
          <div className="text-white text-3xl font-semibold my-[50px]">
            Frequently Asked Questions -
          </div>
          <div
            className="text-purple-500 text-3xl font-semibold my-[50px] "
            style={{
